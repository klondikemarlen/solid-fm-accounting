      ...
      >
        ...
        >
          ...
          <div class="text-center px-5">
            <h2 class="text-h3 font-weight-semibold mb-4 mx-10">Solid FM Accounting</h2>
            <div class="text-subtitle-1 mb-6 mt-n3 font-weight-bold">Solid FM</div>
            <div class="mt-6 text-center">
              ...
              <div class="text-subtitle-1 mt-5">Using your SSO Credentials</div>
              <v-divider class="my-2" />
              <em style="font-weight: 700">Reliable, Secure, and Easy</em>
            </div>
          </div>
        </div>
      </v-col>
